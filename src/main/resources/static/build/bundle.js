...
var app = (function () {
    ...
    // (109:8) {#each freelancers as freelancer}
    function create_each_block_1$1(ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*freelancer*/ ctx[3].name + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*freelancer*/ ctx[3].email + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(td0, file$2, 110, 16, 2861);
    			add_location(td1, file$2, 111, 16, 2905);
    			add_location(tr, file$2, 109, 12, 2839);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*freelancers*/ 4 && t0_value !== (t0_value = /*freelancer*/ ctx[3].name + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*freelancers*/ 4 && t2_value !== (t2_value = /*freelancer*/ ctx[3].email + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(109:8) {#each freelancers as freelancer}",
    		ctx
    	});
    ...
    // (119:8) {#each Array(nrOfPages) as _, i}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "#/freelancers?page=" + (/*i*/ ctx[11] + 1));
    			toggle_class(a, "active", /*currentPage*/ ctx[0] == /*i*/ ctx[11] + 1);
    			add_location(a, file$2, 120, 16, 3124);
    			attr_dev(li, "class", "page-item");
    			add_location(li, file$2, 119, 12, 3084);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(119:8) {#each Array(nrOfPages) as _, i}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value_1 = /*freelancers*/ ctx[2];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h10, file$2, 70, 0, 1755);
    			attr_dev(label0, "class", "form-label");
    			attr_dev(label0, "for", "name");
    			add_location(label0, file$2, 74, 12, 1884);
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "id", "name");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$2, 75, 12, 1947);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$2, 73, 8, 1853);
    			attr_dev(div1, "class", "row mb-3");
    			add_location(div1, file$2, 72, 4, 1821);
    			attr_dev(label1, "class", "form-label");
    			attr_dev(label1, "for", "email");
    			add_location(label1, file$2, 85, 12, 2206);
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "id", "email");
    			attr_dev(input1, "type", "text");
    			add_location(input1, file$2, 86, 12, 2271);
    			attr_dev(div2, "class", "col");
    			add_location(div2, file$2, 84, 8, 2175);
    			attr_dev(div3, "class", "row mb-3");
    			add_location(div3, file$2, 83, 4, 2143);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$2, 94, 4, 2469);
    			attr_dev(form, "class", "mb-5");
    			add_location(form, file$2, 71, 0, 1796);
    			add_location(h11, file$2, 99, 0, 2587);
    			attr_dev(th0, "scope", "col");
    			add_location(th0, file$2, 103, 12, 2675);
    			attr_dev(th1, "scope", "col");
    			add_location(th1, file$2, 104, 12, 2714);
    			add_location(tr, file$2, 102, 8, 2657);
    			add_location(thead, file$2, 101, 4, 2640);
    			add_location(tbody, file$2, 107, 4, 2775);
    			attr_dev(table, "class", "table");
    			add_location(table, file$2, 100, 0, 2613);
    			attr_dev(ul, "class", "pagination");
    			add_location(ul, file$2, 117, 4, 3005);
    			add_location(nav, file$2, 116, 0, 2994);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*freelancer*/ ctx[3].name);
    			append_dev(form, t4);
    			...
    			set_input_value(input1, /*freelancer*/ ctx[3].email);
    			append_dev(form, t7);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*createFreelancer*/ ctx[4], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*freelancer*/ 8 && input0.value !== /*freelancer*/ ctx[3].name) {
    				set_input_value(input0, /*freelancer*/ ctx[3].name);
    			}

    			if (dirty & /*freelancer*/ 8 && input1.value !== /*freelancer*/ ctx[3].email) {
    				set_input_value(input1, /*freelancer*/ ctx[3].email);
    			}

    			if (dirty & /*freelancers*/ 4) {
    				each_value_1 = /*freelancers*/ ctx[2];
    				validate_each_argument(each_value_1);
    				let i;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let nrOfPages = 0;
    	let freelancers = [];
    	let freelancer = { name: null, email: null };
    	...
    	function getFreelancers() {
    		...
    		axios(config).then(function (response) {
    			$$invalidate(2, freelancers = response.data.content);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('freelancers' in $$props) $$invalidate(2, freelancers = $$props.freelancers);
    		if ('freelancer' in $$props) $$invalidate(3, freelancer = $$props.freelancer);
    	};
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = text(t10_value);
    			t11 = space();
    			add_location(td0, file$1, 161, 16, 4333);
    			add_location(td1, file$1, 162, 16, 4377);
    			add_location(td2, file$1, 163, 16, 4417);
    			add_location(td3, file$1, 164, 16, 4458);
    			add_location(td4, file$1, 165, 16, 4499);
    			add_location(td5, file$1, 166, 16, 4544);
    			add_location(tr, file$1, 160, 12, 4311);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    			append_dev(tr, td0);
    ...
    // (174:8) {#each Array(nrOfPages) as _, i}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			attr_dev(a, "class", "page-link");
    			attr_dev(a, "href", "#/jobs?page=" + (/*i*/ ctx[16] + 1));
    			toggle_class(a, "active", /*currentPage*/ ctx[2] == /*i*/ ctx[16] + 1);
    			add_location(a, file$1, 175, 16, 4758);
    			attr_dev(li, "class", "page-item");
    			add_location(li, file$1, 174, 12, 4718);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, a);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(174:8) {#each Array(nrOfPages) as _, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h10, "class", "mt-3");
    			add_location(h10, file$1, 81, 0, 1907);
    			attr_dev(label0, "class", "form-label");
    			attr_dev(label0, "for", "description");
    			add_location(label0, file$1, 85, 12, 2029);
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "id", "description");
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$1, 86, 12, 2106);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$1, 84, 8, 1998);
    			attr_dev(div1, "class", "row mb-3");
    			add_location(div1, file$1, 83, 4, 1966);
    			attr_dev(label1, "class", "form-label");
    			attr_dev(label1, "for", "type");
    			add_location(label1, file$1, 96, 12, 2372);
    			option0.__value = "OTHER";
    			option0.value = option0.__value;
    			add_location(option0, file$1, 103, 16, 2610);
    			option1.__value = "TEST";
    			option1.value = option1.__value;
    			add_location(option1, file$1, 104, 16, 2664);
    			option2.__value = "IMPLEMENT";
    			option2.value = option2.__value;
    			add_location(option2, file$1, 105, 16, 2716);
    			option3.__value = "REVIEW";
    			option3.value = option3.__value;
    			add_location(option3, file$1, 106, 16, 2778);
    			...
    			add_location(select, file$1, 97, 12, 2435);
    			attr_dev(div2, "class", "col");
    			add_location(div2, file$1, 95, 8, 2341);
    			attr_dev(label2, "class", "form-label");
    			attr_dev(label2, "for", "earnings");
    			add_location(label2, file$1, 110, 12, 2896);
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "id", "earnings");
    			attr_dev(input1, "type", "number");
    			add_location(input1, file$1, 111, 12, 2967);
    			attr_dev(div3, "class", "col");
    			add_location(div3, file$1, 109, 8, 2865);
    			attr_dev(div4, "class", "row mb-3");
    			add_location(div4, file$1, 94, 4, 2309);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "btn btn-primary");
    			add_location(button0, file$1, 119, 4, 3166);
    			attr_dev(form, "class", "mb-5");
    			add_location(form, file$1, 82, 0, 1941);
    			add_location(h11, file$1, 122, 0, 3261);
    			attr_dev(label3, "for", "");
    			attr_dev(label3, "class", "col-form-label");
    			add_location(label3, file$1, 125, 8, 3340);
    			attr_dev(div5, "class", "col-auto");
    			add_location(div5, file$1, 124, 4, 3308);
    			attr_dev(input2, "class", "form-control");
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "placeholder", "from");
    			add_location(input2, file$1, 128, 8, 3442);
    			attr_dev(div6, "class", "col-3");
    			add_location(div6, file$1, 127, 4, 3413);
    			attr_dev(input3, "class", "form-control");
    			attr_dev(input3, "type", "number");
    			attr_dev(input3, "placeholder", "to");
    			add_location(input3, file$1, 136, 8, 3638);
    			attr_dev(div7, "class", "col-3");
    			add_location(div7, file$1, 135, 4, 3609);
    			attr_dev(button1, "class", "btn btn-secondary");
    			add_location(button1, file$1, 144, 8, 3832);
    			attr_dev(div8, "class", "col-3");
    			add_location(div8, file$1, 143, 4, 3803);
    			attr_dev(div9, "class", "row my-3");
    			add_location(div9, file$1, 123, 0, 3280);
    			attr_dev(th0, "scope", "col");
    			add_location(th0, file$1, 150, 12, 3983);
    			attr_dev(th1, "scope", "col");
    			add_location(th1, file$1, 151, 12, 4029);
    			attr_dev(th2, "scope", "col");
    			add_location(th2, file$1, 152, 12, 4068);
    			attr_dev(th3, "scope", "col");
    			add_location(th3, file$1, 153, 12, 4111);
    			attr_dev(th4, "scope", "col");
    			add_location(th4, file$1, 154, 12, 4151);
    			attr_dev(th5, "scope", "col");
    			add_location(th5, file$1, 155, 12, 4198);
    			add_location(tr, file$1, 149, 8, 3965);
    			add_location(thead, file$1, 148, 4, 3948);
    			add_location(tbody, file$1, 158, 4, 4261);
    			attr_dev(table, "class", "table");
    			add_location(table, file$1, 147, 0, 3921);
    			attr_dev(ul, "class", "pagination");
    			add_location(ul, file$1, 172, 4, 4639);
    			add_location(nav, file$1, 171, 0, 4628);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*currentPage, nrOfPages*/ 12) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function getJobs() {
    		...
    		axios(config).then(function (response) {
    			$$invalidate(4, jobs = response.data.content);
    	...
    	$$self.$inject_state = $$props => {
    		if ('earningsMin' in $$props) $$invalidate(0, earningsMin = $$props.earningsMin);
    		if ('earningsMax' in $$props) $$invalidate(1, earningsMax = $$props.earningsMax);
    		...
    		if ($$self.$$.dirty & /*$querystring*/ 256) {
    			{
    				...
    				if (searchParams.has("page")) {
    					$$invalidate(2, currentPage = searchParams.get("page"));
    				} else {
