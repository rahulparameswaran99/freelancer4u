...
var app = (function () {
    ...
    const file$3 = "src\\pages\\Freelancers.svelte";
    ...
    // (111:8) {#each freelancers as freelancer}
    function create_each_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(111:8) {#each freelancers as freelancer}",
    		ctx
    	});
    ...
    // (121:8) {#each Array(nrOfPages) as _, i}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(121:8) {#each Array(nrOfPages) as _, i}",
    		ctx
    	});
    ...
    const file$2 = "src\\pages\\Jobs.svelte";
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ isAuthenticated, user, $user });
    	return [$user];
    }
